#!/usr/bin/env python3
"""
Magic8 Data Processor - Optimized Version 2
Fixes CSV output issues by ensuring consistent field counts
"""
...
def main():
    ...
    output_path = "/Users/jt/magic8/magic8-accuracy-predictor/data/processed_optimized_v2"
    
    # Create processor with batch size
    processor = Magic8DataProcessorOptimized(source_path, output_path, batch_size=5000)
    
    # Process all data
    logger.info("Starting Magic8 data processing (optimized v2)...")
    logger.info("This version fixes CSV output consistency issues")
